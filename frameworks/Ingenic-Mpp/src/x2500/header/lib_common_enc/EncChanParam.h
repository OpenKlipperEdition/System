...
typedef AL_INTROSPECT (category = "debug") struct __AL_ALIGNED__ (4) AL_t_EncChanParam
{
  ...
  uint8_t AspectRatioUnit;
  uint16_t X_Density;
  uint16_t Y_Density;

  uint8_t uSRDThreshold;
