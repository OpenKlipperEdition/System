...
void *alignPtr(void* ptr, uintptr_t align)
{
...
#if OPTIMIZE && defined(__mips_msa)
#include <msa.h>
#define PART0_OP 1
#define PART1_OP 1
#define PART2_OP 1

#include "sgbm/partfunc.cpp"
#include "sgbm/part0.cpp"
#include "sgbm/part2.cpp"

void StereoSgbm::compute(IMat &img1, IMat &img2, IMat &disp1)
{
  compute_msa(img1, img2, disp1, params);
}
