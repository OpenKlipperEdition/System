...
BUILD_QMAKE_DEVICE:=$(BUILD_SYSTEM)/build_qmake.mk
BUILD_BUSYBOX:=$(BUILD_SYSTEM)/build_busybox.mk
BUILD_KERNEL_MODULE:=$(BUILD_SYSTEM)/build_kernel_module.mk
BUILD_RTOS_STATIC_MODULE:=$(BUILD_SYSTEM)/build_rtos_module.mk
BUILD_RTOS_STATIC_LIBRARY:=$(BUILD_SYSTEM)/build_rtos_library.mk
BUILD_RTOS_EXECUTABLE_MODULE:=$(BUILD_SYSTEM)/build_rtos_executable.mk
BUILD_RISCV_CMAKE_DEVICE:=$(BUILD_SYSTEM)/build_riscv_cmake.mk
BUILD_CUSTOM_IMAGE := $(BUILD_SYSTEM)/build_custom_image.mk
