#ifndef CONV2D_NORM_FIXPOINT_MSA_H
#define CONV2D_NORM_FIXPOINT_MSA_H
...
namespace tnn {
class conv2d_norm_fixpoint_msa: public layer {
 public:
 conv2d_norm_fixpoint_msa(std::size_t in_channels, std::size_t out_channels, std::size_t kernel_size, std::size_t stride = 1, std::size_t padding = 0, bool bias = true,
