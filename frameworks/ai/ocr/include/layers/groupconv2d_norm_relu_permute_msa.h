#ifndef GROUPCONV2D_NORM_RELU_PERMUTE_MSA_H
#define GROUPCONV2D_NORM_RELU_PERMUTE_MSA_H
...
namespace tnn {
  class groupconv2d_norm_relu_permute_msa: public layer{
 public:
 groupconv2d_norm_relu_permute_msa(std::size_t in_channels, std::size_t out_channels,
                       std::size_t kernel_size, std::size_t group, std::size_t stride = 1,
     ...
     : m_in_channels(in_channels), m_out_channels(out_channels),
        m_kernel_size(kernel_size), m_stride(stride),
...
#endif /* GROUPCONV2D_NORM_RELU_PERMUTE_MSA_H */
