 ...
 */
typedef enum {
	DLOG_ERROR_NONE = 0, /**< Successful */
	DLOG_ERROR_INVALID_PARAMETER = -EINVAL, /**< Invalid parameter */
	DLOG_ERROR_NOT_PERMITTED = -EPERM, /**< Operation not permitted */
} dlog_error_e;
/**
 * @}
 */
...
#define NOP(fmt,arg...) ({ do { __dlog_no_print(fmt,##arg); } while (0); })
