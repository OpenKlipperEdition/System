...
device_types_diff = ('nor', 'nand', 'mmc')
...
img_types = ('normal', 'directory', 'ubifs', 'jffs2', 'cramfs', 'yaffs2')
...
# boot mode supported by system defined
bootmodes = ('normal', 'recovery')
# enum defination relative to bootmodes
e_bootmodes = {'normal': 0, 'recovery': 0xcc}

# limit size of difference package
...
class Config(object):
    ...
    def get_src_path(cls):
        return cls.v['src_path']

    @classmethod
    def set_src_path(cls, path):
        cls.v['src_path'] = path

    @classmethod
    def get_dst_path(cls):
        return cls.v['dst_path']

    @classmethod
    def set_dst_path(cls, path):
        cls.v['dst_path'] = path

    @classmethod
    def get_ota_mode(cls):
        return cls.v['otamode']

    @classmethod
    def set_ota_mode(cls, mode):
        cls.v['otamode'] = mode
    ...
    # get limit size of difference update package
    @classmethod
    def get_limitsize(cls):
        return cls.v['limitsize']

    @classmethod
    def set_limitsize(cls, size):
        cls.v['limitsize'] = size
    ...
    @classmethod
    def get_singlepkg(cls):
        return cls.v['singlepkg']

    @classmethod
    def set_singlepkg(cls, singlepkg):
        cls.v['singlepkg'] = singlepkg
    # public key path
    @classmethod
