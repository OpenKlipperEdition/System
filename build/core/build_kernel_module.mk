...
$(DRIVER_TARGET_LINK): KERNEL_EXTRA_CFLAGS:="$(LOCAL_CFLAGS) -I$(TOP_DIR)/$(LOCAL_C_INCLUDES)"
$(DRIVER_TARGET_LINK): $(TARGET_SRC_FILES)
	...
	@echo "modules: " >> $@
	@echo "	make V=1 -C " $(TOP_DIR)/$(dir $(DRIVER_TARGET_CONFIG)) M=$(TOP_DIR)/$(dir $@) modules "KCFLAGS="'$(KERNEL_EXTRA_CFLAGS)' >> $@
