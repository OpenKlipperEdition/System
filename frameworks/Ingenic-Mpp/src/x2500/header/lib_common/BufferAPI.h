...
typedef struct
{
  ...
  bool bUseExtraBuf[AL_BUFFER_MAX_CHUNK];
  void *extraBufHandle[AL_BUFFER_MAX_CHUNK];
}AL_TBuffer;
...
*****************************************************************************/
AL_TBuffer* AL_Buffer_Create_And_Allocate(AL_TAllocator* pAllocator, size_t zSize, bool bUseExtraBuf, void *extraBufHandle, PFN_RefCount_CallBack pCallBack);
...
/*************************************************************************//*!
   ...
   \return Returns a buffer if successful. Returns NULL otherwise
*****************************************************************************/
AL_TBuffer* AL_Buffer_Create_And_AllocateNamed(AL_TAllocator* pAllocator, size_t zSize, bool bUseExtraBuf, void *extraBufHandle, PFN_RefCount_CallBack pCallBack, char const* name);
...
/*************************************************************************//*!
   ...
   \return Returns a buffer if successful. Returns NULL otherwise
*****************************************************************************/
AL_TBuffer* AL_Buffer_Create(AL_TAllocator* pAllocator, AL_HANDLE hBuf, size_t zSize, bool bUseExtraBuf, void *extraBufHandle, PFN_RefCount_CallBack pCallBack);
...
/*************************************************************************//*!
   ...
   \return Returns a buffer if successful. Returns NULL otherwise
*****************************************************************************/
AL_TBuffer* AL_Buffer_WrapData(uint8_t* pData, size_t zSize, bool bUseExtraBuf, void *extraBufHandle, PFN_RefCount_CallBack pCallBack);
...
*****************************************************************************/
int AL_Buffer_AllocateChunk(AL_TBuffer* hBuf, size_t zSize, bool bUseExtraBuf, void *extraBufHandle, char const* name);
...
/*************************************************************************//*!
   ...
   \return Returns the chunk index if succeeded, BAD_CHUNK_INDEX otherwise
*****************************************************************************/
int AL_Buffer_AddChunk(AL_TBuffer* hBuf, AL_HANDLE hChunk, size_t zSize, bool bUseExtraBuf, void *extraBufHandle);
