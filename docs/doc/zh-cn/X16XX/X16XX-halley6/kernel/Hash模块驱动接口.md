...
```
```
Symbol: CRYPTO_DEV_INGENIC_SHA [=n] 
...
(1) -> Hardware crypto devices (CRYPTO_HW [=n]) 

Prompt: [SHA] Support for Ingenic SHA hw accelerator 

 Location: 

(2) -> Ingenic device-drivers Configurations 
...
用户可根据实际需求配置HASH驱动，配置界面如下:

![2022-11-11 10-31-10屏幕截图](assets/Hash模块驱动接口.0.png)

![2022-11-11 10-30-22屏幕截图](assets/Hash模块驱动接口.1.png)
