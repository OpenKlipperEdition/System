...
/* jz cim ctrl id */
#define JZ_CID_CUSTOM_BASE	 (V4L2_CID_USER_BASE | 0xf000)
#define JZ_CID_SCALE_SHARP	 (JZ_CID_CUSTOM_BASE + 1)
#define JZ_CID_HIST_EN		 (JZ_CID_CUSTOM_BASE + 2)
#define JZ_CID_HIST_GAIN_ADD	 (JZ_CID_CUSTOM_BASE + 3)
#define JZ_CID_HIST_GAIN_MUL	 (JZ_CID_CUSTOM_BASE + 4)
#define JZ_CID_CROP_WAY		 (JZ_CID_CUSTOM_BASE + 5)

/* crop way */
enum {
	/* set format sets the crop zone */
	CROP_SPECIFY_ZONE,
	/* get_cropcap gets the maximum zone*/
	CROP_BASE_MAX_PIC,
};
