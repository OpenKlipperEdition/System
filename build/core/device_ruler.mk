...
COMPILER_LIB_PATH:=$(COMPILER_PATH)/lib/gcc/$(DEVICE_COMPILER_PREFIX)/$(COMPILER_LIB_VERSION)/$(arch_variant_gcc_dir)

ifeq ($(strip x$(arch_variant_libc_dir)),x)
ROOT_PATH?=$(COMPILER_PATH)/$(DEVICE_COMPILER_PREFIX)/libc
CRT_PATH?=$(COMPILER_PATH)/$(DEVICE_COMPILER_PREFIX)/libc/usr/lib
LIBC_PATH?=$(COMPILER_PATH)/$(DEVICE_COMPILER_PREFIX)/libc/lib
else
ROOT_PATH?=$(COMPILER_PATH)/$(DEVICE_COMPILER_PREFIX)/libc/$(arch_variant_libc_dir)
CRT_PATH?=$(COMPILER_PATH)/$(DEVICE_COMPILER_PREFIX)/libc/$(arch_variant_libc_dir)/usr/lib
LIBC_PATH?=$(COMPILER_PATH)/$(DEVICE_COMPILER_PREFIX)/libc/$(arch_variant_libc_dir)/lib
endif
