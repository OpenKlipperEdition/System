...
uint32_t AL_sSettings_GetMaxCPBSize(AL_TEncChanParam const* pChParam);

void AL_Dump_TRCParam(AL_TRCParam *rcParam);
void AL_Dump_TGopParam(AL_TGopParam *gopParam);
void AL_Dump_TEncChanParam(AL_TEncChanParam *param);
void AL_Dump_TEncSettings(AL_TEncSettings *pSettings);
