...
void compute_x86(IMat &img1, IMat &img2, IMat &disp1, SgbmDisparityParam *params)
{
#if CV_SIMD128
	  ...
	  */
	  ...
	  for( x = x1; x != x2; x += dx )
	      ...
	      else
		{
		  ...
		  // printf("[%d]: %d , %d , %d, %d\n", x, minLr[0][xm], minLr[0][xm +1],
		  //        minLr[0][xm + 2], minLr[0][xm +3]);
