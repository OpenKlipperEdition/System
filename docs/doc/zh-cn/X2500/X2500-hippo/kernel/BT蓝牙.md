...
X2500使用的是AP6212芯片，AP6212是基于BCM4340A1方案的集成wifi和bluetooth的功能模块。
...
1. 配置电源管理相关gpio
 ...
 ingenic,reg-on-gpio = <&gpa 24 GPIO_ACTIVE_LOW INGENIC_GPIO_NOBIAS>;

 ingenic,wake-gpio = <&gpa 15 GPIO_ACTIVE_LOW INGENIC_GPIO_NOBIAS>;
...
bsa_server -r 15 -p /lib/firmware/bluetooth/BCM43430A1.hcd -u /var/run/ -d /dev/ttyS0
