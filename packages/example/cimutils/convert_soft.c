...
int YUYV_to_RGB888 (void *src_buf, void *dst_buf, size_t src_height ,size_t src_width, size_t dstStride)
{
    ...
    if(src_width > src_height){
        int line_offset = (src_width-src_height)/2;
        pixel = pixel + line_offset * dst_width;
    }
...
int YUYV_to_RGB888_90_DEGREE (void *src_buf, void *dst_buf, size_t src_height ,size_t src_width, size_t dstStride)
{
    __u8 y0 = 0;
    __u8 u = 0;
    __u8 y1 = 0;
    ...
    {
        col = 0 ;
        for( dst_line = src_width - 1; col < src_width/2; dst_line = dst_line - 2)
        {
            y0 = yuv422_samp[line * src_width/2 + col].b1;
            u  = yuv422_samp[line * src_width/2 + col].b2;
            y1 = yuv422_samp[line * src_width/2 + col].b3;
            ...
            pixel[dst_line * dst_width + (src_height - 1 - line)].red = colorR;
            pixel[dst_line * dst_width + (src_height - 1 - line)].green = colorG;
            pixel[dst_line * dst_width + (src_height - 1 - line)].blue = colorB;
            ...
            pixel[(dst_line-1) * dst_width + (src_height - 1 - line)].red = colorR;
            pixel[(dst_line-1) * dst_width + (src_height - 1 - line)].green = colorG;
            pixel[(dst_line-1) * dst_width + (src_height - 1 - line)].blue = colorB;
...
int YUYV_to_RGB888_270_DEGREE (void *src_buf, void *dst_buf, size_t src_height ,size_t src_width, size_t dstStride)
{
    __u8 y0 = 0;
    __u8 u = 0;
    __u8 y1 = 0;
    ...
    for(line = 0; line < src_height; line++)
    {
        ...
        for( dst_line = src_width - 1; col < src_width/2; dst_line = dst_line - 2)
        {
            ...
            pixel[dst_line * dst_width + (line)].red = colorR;
            pixel[dst_line * dst_width + (line)].green = colorG;
            pixel[dst_line * dst_width + (line)].blue = colorB;
            ...
            pixel[(dst_line-1) * dst_width + (line)].red = colorR;
            pixel[(dst_line-1) * dst_width + (line)].green = colorG;
            pixel[(dst_line-1) * dst_width + (line)].blue = colorB;
...
int YUYV_to_RGB888_FLIP_Y (void *src_buf, void *dst_buf, size_t src_height ,size_t src_width, size_t dstStride)
{
    ...
    for(line = 0; line < src_height; line++)
    {
	  ...
	  colorR = (colorR < 0) ? 0 : ((colorR > 255 ) ? 255 : colorR);
          ...
          pixel[line * dst_width + src_height - (dst_col)].red = colorR;
	  pixel[line * dst_width + src_height - (dst_col)].green = colorG;
	  pixel[line * dst_width + src_height - (dst_col)].blue = colorB;
	  ...
	  colorR = (colorR < 0) ? 0 : ((colorR > 255 ) ? 255 : colorR);
          ...
          pixel[line * dst_width + src_height - (dst_col + 1)].red = colorR;
	  pixel[line * dst_width + src_height - (dst_col + 1)].green = colorG;
	  pixel[line * dst_width + src_height - (dst_col + 1)].blue = colorB;
