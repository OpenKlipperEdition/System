...
clock: clock-controller@0x10000000 {
 ...
 compatible = "ingenic,x2000-clocks";
...
使用cpm驱动内核不需要添加特殊配置，只依赖soc的配置选项CONFIG_SOC_X2000，相关代码在：`module_drivers/drivers/clk/ingenic-v2/`
...
在`module_drivers/dts/x1600.dtsi`或`module_drivers/dts/x1600/x1600.dtsi`中cim节点的描述为：
```c
cim: cim@0x13060000 {
