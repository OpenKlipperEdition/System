...
#define TAG  "camera_h265enc_test"
...
{
        printf("Usage: camera-h265enc [OPTIONS] [SLICES PATH]\n\n"
               "Options:\n"
               ...
               " -o                  output h265 encode filename.(default camera_enc_out_v1.h265)\n"
               " -H                  help\n\n"
               "Video presets:\n");
}
...
int main(int argc, char **argv)
{
        ...
        IHAL_INT8 *output_path = "camera_enc_out_v1.h265";
        ...
        handle = IHal_CodecCreate(H265_ENC);
        if (!handle) {
        ...
        param.codecparam.h265e_param.rc_mode = IMPP_ENC_RC_MODE_CBR;
        param.codecparam.h265e_param.target_bitrate = target_bitrate;
        param.codecparam.h265e_param.max_bitrate    = target_bitrate;
        param.codecparam.h265e_param.gop_len        = gop_len;
        ...
        param.codecparam.h265e_param.frameRateNum   = frame_rate_num;
        param.codecparam.h265e_param.frameRateDen   = 1;
        /* param.codecparam.h265e_param.maxPictureSize = image_width * image_height; */
        param.codecparam.h265e_param.enc_width      = image_width;
        param.codecparam.h265e_param.enc_height     = image_height;
        param.codecparam.h265e_param.src_width      = image_width;
        param.codecparam.h265e_param.src_height     = image_height;
        param.codecparam.h265e_param.src_fmt        = image_fmt;
        ...
        for (int i = 0; i < CAMERA_BUFFER_NUM; i++) {
                ...
                if (ret) {
                        printf("set h265 encoder src buffer failed\r\n");
                        goto destroy_codec;
                }
        }
