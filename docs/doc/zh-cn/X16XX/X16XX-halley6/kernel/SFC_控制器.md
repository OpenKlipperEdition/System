...
(1) -> [SFC] (SPI Nand/Nor Flash) Drivers 
...
NAND预留空间，用于存储SN号、MAC地址、License等信息的区域，可配置预留区域的大 小，默认单个区域大小为1MB。
```
...
***x1600_sfc_nor_lpddr2_linux.cfg***
...
![cloner_nor_add_params](assets/SFC_控制器.0.png)
