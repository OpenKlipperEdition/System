...
subdir_moduledesc := \
	$(shell $(BUILD_SYSTEM)/tools/findleaves.py --prune=$(OUT_DIR) --prune=.repo --prune=.git --prune=kernel --prune=u-boot --prune=prebuilts --prune=build --prune=buildroot --prune=device $(subdirs) ModuleDescription)
endif
