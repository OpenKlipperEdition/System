...
class EchoCancellationImpl : public EchoCancellation,
 ...
 private:
  ...
  int set_dtd_enable(int enable) override;
  int set_dtd_parameters(int num, float ratio, float thd) override;
  int set_aec_mode(int aec_mode) override;
  int set_aec_safe_suppression_value(float safe_sup_value) override;
