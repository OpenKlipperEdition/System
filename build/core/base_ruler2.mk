...
$(2):PRIVATE_MODULE_CFLAGS:=$(LOCAL_CFLAGS)
$(2):PRIVATE_MODULE_CPPFLAGS:=$(LOCAL_CPPFLAGS)
...
$(2):PRIVATE_TARGET_CPPFLAGS:=$(__global_target_cflags)
$(2):PRIVATE_TARGET_ASMFLAGS:=$(LOCAL_ASMFLAGS)
endef
...
$(LOCAL_MODULE_BUILD)-clean:PRIVATE_MODULE_DIR_CLEAN:=$(__local_intermediate)
...
$(hide) $(PRIVATE_BUILD) \
		...
		$(addprefix -isystem , $(PRIVATE_TARGET_INCLUDES))	   \
		$(addprefix -isystem , $(PRIVATE_TARGET_ANDROID_INCLUDES)) \
		$(PRIVATE_TARGET_CPPFLAGS) \
		$(PRIVATE_MODULE_CPPFLAGS) \
		-MD -MF $(@:.o=.d) -c -o $@ $<
$(call transform-d-to-p)
endef
