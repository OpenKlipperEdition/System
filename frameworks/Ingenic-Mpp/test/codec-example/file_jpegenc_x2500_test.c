...
{
        printf("Usage: file-jpegenc-x2500-example [OPTIONS] [SLICES PATH]\n\n"
               "Options:\n"
               " -i                Coded source file.\n"
               " -w                Source file width.\n"
        ...
        for (;;) {
                ...
                if (!ret) {
                        ...
                        if (!ret) {
                                ...
                                read(srcfd, (void *)srcbuf[buf.index].vaddr, pic_width * pic_height * 3 / 2);
...
int main(int argc, char **argv)
{
        ...
        // fill buffer before
        for (int i = 0; i < srcbuf_nums; i++) {
                read(srcfd, (void *)srcbuf[i].vaddr, pic_width * pic_height * 3 / 2);
